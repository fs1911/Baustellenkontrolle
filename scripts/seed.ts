...
const COMPANIES = [
  {
    key: "tozzo",
    name: "tozzo gruppe ag",
    short: "TOZ",
    street: "Industriestrasse 1",
    postal: "5242",
    city: "Birr",
    color: "#c2410c",
    distribution: ["ims@tozzo-gruppe.example"],
    sender: "tozzo gruppe ag – IMS",
  },
  {
    key: "hochbau",
    name: "Beispielgesellschaft Hochbau AG",
    short: "BHB",
    street: "Bahnhofstrasse 20",
    postal: "5000",
    city: "Aarau",
    color: "#1d4ed8",
    distribution: ["bauleitung@hochbau.example"],
    sender: "Hochbau AG – Bauleitung",
  },
  {
    key: "tiefbau",
    name: "Beispielgesellschaft Tiefbau AG",
    short: "BTB",
    street: "Werkhofweg 5",
    postal: "8050",
    city: "Zürich",
    color: "#15803d",
    distribution: ["tiefbau@tiefbau.example"],
    sender: "Tiefbau AG – Bauleitung",
  },
] as const;
...
const SITES = [
  {
    ...
    company: "hochbau",
    number: "BHB-24-017",
    name: "Wohnüberbauung Birr",
    street: "Feldstrasse 12",
    postal: "5242",
    city: "Birr",
    canton: "AG",
    project: "P-2024-017",
  },
  {
    ...
    company: "tozzo",
    number: "TOZ-25-004",
    name: "Sanierung Gewerbeobjekt Aargau",
    street: "Gewerbering 8",
    postal: "5600",
    city: "Lenzburg",
    canton: "AG",
    project: "P-2025-004",
  },
  {
    ...
    company: "tiefbau",
    number: "BTB-25-009",
    name: "Infrastrukturprojekt Beispielstrasse",
  ...
  },
  {
    ...
    company: "hochbau",
    number: "BHB-25-031",
    name: "Mehrfamilienhaus Zürich Nord",
    street: "Wehntalerstrasse 400",
    postal: "8046",
    city: "Zürich",
    canton: "ZH",
    project: "P-2025-031",
...
const USERS = [
  {
    key: "admin",
    name: "Andrea Keller",
    email: "admin@tozzo-gruppe.example",
    title: "Administratorin IMS",
    roles: [{ role: "admin", company: null }],
  },
  {
    key: "sibe",
    name: "Marco Bühler",
    email: "sibe@tozzo-gruppe.example",
    title: "SIBE Gruppe",
    roles: [{ role: "group_ims", company: null }],
  },
  {
    key: "pl_hochbau",
    name: "Sandra Meier",
    email: "s.meier@hochbau.example",
    title: "Projektleiterin Hochbau",
    roles: [{ role: "project_manager", company: "hochbau" }],
  },
  {
    key: "pl_tiefbau",
    name: "Luca Rossi",
    email: "l.rossi@tiefbau.example",
    title: "Bauleiter Tiefbau",
    roles: [{ role: "project_manager", company: "tiefbau" }],
  },
  {
    key: "pl_tozzo",
    name: "Nina Frei",
    email: "n.frei@tozzo-gruppe.example",
    title: "Projektleiterin Sanierungen",
    roles: [{ role: "project_manager", company: "tozzo" }],
  },
  { key: "polier_birr", name: "Beat Huber", email: "b.huber@hochbau.example", title: "Polier", roles: [] },
  {
    key: "mgmt",
    name: "Christine Weber",
    email: "gl@tozzo-gruppe.example",
    title: "Geschäftsleitung",
    roles: [{ role: "viewer", company: null }],
  },
] as const;
...
const T: Record<string, FindingTemplate[]> = {
  "absturz.seitenschutz": [
    {
      sub: "absturz.seitenschutz",
      assessment: "negative",
      risk: "high",
      title: "Seitenschutz am Deckenrand fehlt",
      description: "Am Deckenrand im 2. OG fehlt auf ca. 8 m Länge der Seitenschutz. Absturzhöhe rund 6 m.",
      action: "Dreiteiligen Seitenschutz (Geländer-, Zwischenholm, Bordbrett) montieren; Bereich bis dahin sperren.",
      role: "Polier",
      trade: "Rohbau",
      location: "2. OG, Nordseite",
    },
    {
      sub: "absturz.seitenschutz",
      assessment: "negative",
      risk: "critical",
      title: "Ungesicherte Absturzkante Treppenhaus",
      description: "Treppenhauskern ohne Seitenschutz, Mitarbeitende arbeiten direkt an der Kante. Absturzhöhe über 3 m.",
      action: "Arbeiten an der Kante sofort einstellen, Seitenschutz montieren, Instruktion durchführen.",
      role: "Polier",
      trade: "Rohbau",
      location: "Treppenhaus B",
    },
    {
      sub: "absturz.seitenschutz",
      assessment: "negative",
      risk: "high",
      title: "Seitenschutz demontiert und nicht wieder erstellt",
      description: "Seitenschutz für Materialumschlag entfernt und nicht wieder montiert.",
      action: "Seitenschutz wiederherstellen; Umschlagstelle mit Absturzsicherung (Tor) ausrüsten.",
      role: "Polier",
      trade: "Rohbau",
      location: "Anlieferung Kran",
    },
  ],
  "absturz.dach": [
    {
      ...
      assessment: "negative",
      risk: "critical",
      title: "Lichtkuppeln auf Flachdach nicht gesichert",
      description: "Drei Lichtkuppeln ohne durchbruchsichere Abdeckung, Dachdecker arbeiten in unmittelbarer Nähe.",
      action: "Lichtkuppeln mit durchbruchsicheren Gittern oder Abdeckungen sichern.",
      role: "Subunternehmer Gebäudehülle",
      trade: "Gebäudehülle",
      location: "Flachdach",
    },
  ],
  "geruest.belag": [
    {
      ...
      assessment: "negative",
      risk: "high",
      title: "Gerüstbelag unvollständig",
      description: "Auf Gerüstlage 3 fehlen zwei Belagsteile, Lücke von ca. 60 cm.",
      action: "Fehlende Belagsteile durch Gerüstbauer ersetzen lassen; Lage bis dahin sperren.",
      role: "Gerüstbauer",
      trade: "Gerüstbau",
      location: "Fassade Süd",
    },
  ],
  "geruest.freigabe": [
    {
      sub: "geruest.freigabe",
      assessment: "positive",
      risk: null,
      title: "Gerüst vorbildlich erstellt und freigegeben",
      description: "Fassadengerüst vollständig, Freigabe gut sichtbar am Zugang angebracht, Treppenturm vorhanden.",
      trade: "Gerüstbau",
      location: "Fassade West",
    },
    {
      sub: "geruest.freigabe",
      assessment: "improvement",
      risk: "low",
      title: "Gerüstfreigabe besser sichtbar anbringen",
      description: "Gerüstfreigabe vorhanden, jedoch nur im Baubüro. Sie sollte am Zugang ersichtlich sein.",
      action: "Gerüstkarte am Aufgang anbringen.",
      role: "Bauleitung",
      trade: "Gerüstbau",
    },
  ],
  "leitern.zustand": [
    {
      ...
      assessment: "negative",
      risk: "medium",
      title: "Beschädigte Anstellleiter im Einsatz",
      description: "Anstellleiter mit angerissener Sprosse wird als Zugang zur Schalung verwendet.",
      action: "Leiter ausser Betrieb nehmen und ersetzen; Treppenturm als Zugang prüfen.",
      role: "Polier",
      trade: "Rohbau",
    },
  ],
  "oeffnungen.abdeckung": [
    {
      sub: "oeffnungen.abdeckung",
      assessment: "negative",
      risk: "high",
      title: "Bodenöffnung nur lose abgedeckt",
      description: "Aussparung für Installationen mit loser Platte abgedeckt, nicht fixiert und nicht beschriftet.",
      action: "Abdeckung tragfähig ausführen, fixieren und mit «Öffnung» beschriften.",
      role: "Polier",
      trade: "Rohbau",
      location: "1. OG, Wohnung 1.3",
    },
  ],
  "psa.helm": [
    {
      ...
      assessment: "negative",
      risk: "medium",
      title: "Mitarbeitende ohne Schutzhelm",
      description: "Zwei Mitarbeitende im Kranbereich ohne Schutzhelm angetroffen.",
      action: "Mitarbeitende direkt ansprechen; Helmtragpflicht im Toolbox-Meeting wiederholen.",
      role: "Polier",
      trade: "Rohbau",
    },
    {
      ...
      assessment: "negative",
      risk: "medium",
      title: "Helmtragpflicht nicht eingehalten",
      description: "Mitarbeitende eines Subunternehmers arbeiten ohne Schutzhelm unter dem Gerüst.",
      action: "Subunternehmer schriftlich auf Helmtragpflicht hinweisen, Nachkontrolle.",
      role: "Subunternehmer",
      trade: "Fassade",
    },
  ],
  "psa.gehoer_augen": [
    {
      sub: "psa.gehoer_augen",
      assessment: "negative",
      risk: "medium",
      title: "Kein Gehörschutz beim Spitzen",
      description: "Spitzarbeiten mit Abbruchhammer ohne Gehör- und Augenschutz.",
      action: "Gehörschutz und Schutzbrille abgeben und tragen; Instruktion.",
      role: "Polier",
      trade: "Rückbau",
    },
  ],
  "psa.warn": [
    {
      ...
      assessment: "positive",
      risk: null,
      title: "Warnkleidung konsequent getragen",
      description: "Alle Mitarbeitenden im Strassenbereich tragen Warnkleidung Klasse 3 – vorbildlich.",
      trade: "Strassenbau",
    },
  ],
  "elektro.provisorium": [
    {
      sub: "elektro.provisorium",
      assessment: "negative",
      risk: "high",
      title: "Elektrisches Provisorium mit Mehrfachsteckern",
      description: "Provisorische Beleuchtung über Mehrfachstecker und nicht vollständig abgewickelte Kabelrolle betrieben.",
      action: "Provisorium durch Elektrofachperson fachgerecht erstellen lassen; Kabelrollen ganz abwickeln.",
      role: "Subunternehmer Elektro",
      trade: "Elektro",
      location: "UG Technikraum",
    },
    {
      sub: "elektro.provisorium",
      assessment: "negative",
      risk: "high",
      title: "Provisorische Beleuchtung ungeschützt",
      description: "Leuchten des Provisoriums hängen an beschädigten Kabeln im Treppenhaus.",
      action: "Provisorium instand stellen, Kabel geschützt und hochgeführt verlegen.",
      role: "Subunternehmer Elektro",
      trade: "Elektro",
  ...
  "elektro.kabel": [
    {
      ...
      assessment: "negative",
      risk: "high",
      title: "Beschädigtes Verlängerungskabel",
      description: "Verlängerungskabel mit beschädigter Isolation liegt in einer Wasserlache.",
      action: "Kabel sofort entfernen und ersetzen; Kabelführung hochgelegt.",
      role: "Polier",
      trade: "Innenausbau",
    },
  ],
  "elektro.verteiler": [
    {
      sub: "elektro.verteiler",
      assessment: "negative",
      risk: "critical",
      title: "Baustromverteiler offen",
      description: "Baustromverteiler mit offener Abdeckung, spannungsführende Teile zugänglich.",
      action: "Verteiler sofort schliessen, durch Elektrofachperson prüfen lassen, FI-Schutz testen.",
      role: "Subunternehmer Elektro",
      trade: "Elektro",
      location: "Installationsplatz",
    },
  ],
  "krane.anschlagmittel": [
    {
      sub: "krane.anschlagmittel",
      assessment: "negative",
      risk: "high",
      title: "Ablegereifes Hebeband im Einsatz",
      description: "Hebeband mit Schnittverletzung und fehlender Etikette wird weiter verwendet.",
      action: "Hebeband entsorgen; Anschlagmittel regelmässig prüfen und dokumentieren.",
      role: "Kranführer",
      trade: "Rohbau",
    },
  ],
  "verkehr.fluchtweg": [
    {
      sub: "verkehr.fluchtweg",
      assessment: "negative",
      risk: "medium",
      title: "Fluchtweg durch Material verstellt",
      description: "Fluchtweg im UG durch Paletten mit Dämmmaterial blockiert.",
      action: "Fluchtweg freiräumen und Lagerplatz ausserhalb bezeichnen.",
      role: "Polier",
      trade: "Innenausbau",
    },
  ],
  "ordnung.stolper": [
    {
      ...
      assessment: "negative",
      risk: "low",
      title: "Unordnung und Stolperstellen im Treppenhaus",
      description: "Schalungsreste, Kabel und Verpackungsmaterial liegen im Treppenhaus herum.",
      action: "Treppenhaus aufräumen; tägliche Aufräumzeit festlegen.",
      role: "Polier",
      trade: "Rohbau",
    ...
    },
    {
      ...
      assessment: "negative",
      risk: "medium",
      title: "Herumliegendes Material auf Verkehrsweg",
      description: "Bewehrungseisen und Abfall liegen auf dem Hauptverkehrsweg, erhebliche Stolpergefahr.",
      action: "Verkehrsweg räumen; Material geordnet lagern.",
      role: "Polier",
      trade: "Rohbau",
    },
    {
      ...
      assessment: "improvement",
      risk: "low",
      title: "Ordnung auf den Etagen verbessern",
      description: "Grundsätzlich ordentlich, Abfallbehälter auf den Etagen könnten häufiger geleert werden.",
      action: "Leerungsintervall der Etagenbehälter erhöhen.",
      role: "Bauleitung",
      trade: "Allgemein",
    },
  ],
  "ordnung.lager": [
    {
      ...
      assessment: "positive",
      risk: null,
      title: "Materiallager sauber organisiert",
      description: "Lagerplätze beschriftet, Material standsicher und ordnungsgemäss gelagert.",
      trade: "Logistik",
    },
  ],
  "graben.verbau": [
    {
      ...
      assessment: "negative",
      risk: "critical",
      title: "Graben ohne Verbau über 1.5 m tief",
      description: "Leitungsgraben ca. 1.8 m tief mit senkrechten Wänden ohne Verbau, Mitarbeitende im Graben.",
      action: "Arbeiten im Graben sofort stoppen, Grabenverbau erstellen oder Böschung abflachen.",
      role: "Vorarbeiter Tiefbau",
      trade: "Tiefbau",
  ...
  "graben.rand": [
    {
      ...
      assessment: "negative",
      risk: "high",
      title: "Aushub direkt am Grabenrand",
      description: "Aushubmaterial direkt am Grabenrand gelagert, Einsturzgefahr und kein sicherer Zugang.",
      action: "Aushub mindestens 0.5 m vom Grabenrand entfernt lagern, Leiter als Zugang stellen.",
      role: "Vorarbeiter Tiefbau",
      trade: "Tiefbau",
    },
  ],
  "gefahrstoffe.lagerung": [
    {
      sub: "gefahrstoffe.lagerung",
      assessment: "negative",
      risk: "medium",
      title: "Kanister ohne Auffangwanne",
      description: "Dieselkanister und Schalöl ohne Auffangwanne neben dem Meteorwasserschacht gelagert.",
      action: "Lagerung in Auffangwanne, Gebinde verschliessen, Schacht schützen.",
      role: "Polier",
      trade: "Tiefbau",
    },
  ],
  "staub_laerm.staub": [
    {
      sub: "staub_laerm.staub",
      assessment: "improvement",
      risk: "medium",
      title: "Staubentwicklung beim Trennen reduzieren",
      description: "Beim Trennen von Betonplatten starke Staubentwicklung. Nassschneiden oder Absaugung wäre zweckmässig.",
      action: "Nassschneidverfahren bzw. Absaugung einsetzen, FFP2-Masken abgeben.",
      role: "Polier",
      trade: "Rückbau",
    },
  ],
  "brand.loeschmittel": [
    {
      sub: "brand.loeschmittel",
      assessment: "positive",
      risk: null,
      title: "Feuerlöscher geprüft und gut sichtbar",
      description: "Feuerlöscher an allen Etagen vorhanden, geprüft und gut sichtbar signalisiert.",
      trade: "Allgemein",
    },
  ],
  "brand.heissarbeiten": [
    {
      sub: "brand.heissarbeiten",
      assessment: "negative",
      risk: "high",
      title: "Schweissarbeiten ohne Brandwache",
      description: "Schweissarbeiten neben brennbarem Dämmmaterial ohne Löschmittel und Brandwache.",
      action: "Heissarbeitsbewilligung einführen, Löschmittel bereitstellen, Brandwache organisieren.",
      role: "Subunternehmer Metallbau",
      trade: "Metallbau",
    },
  ],
  "notfall.plan": [
    {
      ...
      assessment: "positive",
      risk: null,
      title: "Notfallplan aktuell ausgehängt",
      description: "Notfallplan mit Notfallnummern, Standortangaben und Ersthelfenden im Baubüro und am Eingang ausgehängt.",
      trade: "Allgemein",
    },
  ],
  "notfall.material": [
    {
      sub: "notfall.material",
      assessment: "negative",
      risk: "medium",
      title: "Sanitätskasten unvollständig",
      description: "Sanitätskasten im Baubüro unvollständig, Augenspülflasche abgelaufen.",
      action: "Erste-Hilfe-Material ergänzen, monatliche Kontrolle festlegen.",
      role: "Bauleitung",
      trade: "Allgemein",
    },
  ],
  "instruktion.nachweis": [
    {
      sub: "instruktion.nachweis",
      assessment: "negative",
      risk: "medium",
      title: "Instruktion neuer Mitarbeitender nicht nachgewiesen",
      description: "Für zwei temporäre Mitarbeitende liegt kein Instruktionsnachweis vor.",
      action: "Instruktion nachholen und mit Unterschrift dokumentieren.",
      role: "Bauleitung",
      trade: "Allgemein",
    },
  ],
  "instruktion.av": [
    {
      ...
      assessment: "positive",
      risk: null,
      title: "Toolbox-Meeting zu Absturzsicherung durchgeführt",
      description: "Wöchentliches Toolbox-Meeting zum Thema Absturzsicherung mit Teilnehmerliste dokumentiert – gute Praxis.",
      trade: "Allgemein",
    },
  ],
  "umwelt.abfall": [
    {
      ...
      assessment: "improvement",
      risk: "low",
      title: "Abfalltrennung optimieren",
      description: "Mulden sind nicht beschriftet, Holz und Mischabfall werden teilweise gemischt.",
      action: "Mulden beschriften und Abfalltrennung instruieren.",
      role: "Bauleitung",
      trade: "Allgemein",
    },
  ],
  "umwelt.gewaesser": [
    {
      sub: "umwelt.gewaesser",
      assessment: "negative",
      risk: "high",
      title: "Betonwasser in Meteorwasserschacht",
      description: "Betonwasser der Waschstelle fliesst ungeklärt in einen Meteorwasserschacht.",
      action: "Absetzbecken und Neutralisation einrichten, Schacht abdecken.",
      role: "Polier",
      trade: "Tiefbau",
    },
  ],
  "qualitaet.ausfuehrung": [
    {
      sub: "qualitaet.ausfuehrung",
      assessment: "negative",
      risk: "low",
      title: "Abweichung Bewehrungsüberdeckung",
      description: "Stichprobe zeigt ungenügende Distanzhalter, Bewehrungsüberdeckung teilweise unter Planvorgabe.",
      action: "Distanzhalter ergänzen, Abnahme vor Betonage durch Bauleitung.",
      role: "Polier",
      trade: "Rohbau",
    },
  ],
  "qualitaet.schutz": [
    {
      sub: "qualitaet.schutz",
      assessment: "improvement",
      risk: "low",
      title: "Schutz fertiger Fensterbänke",
      description: "Fertig montierte Fensterbänke sind nicht abgedeckt; Beschädigungen könnten vermieden werden.",
      action: "Fensterbänke mit Schutzprofilen abdecken.",
      role: "Bauleitung",
      trade: "Innenausbau",
    },
  ],
  "nachhaltigkeit.energie": [
    {
      sub: "nachhaltigkeit.energie",
      assessment: "improvement",
      risk: "low",
      title: "Bauheizung und Beleuchtung bedarfsgerecht steuern",
      description: "Bauheizung läuft bei offenen Fenstern, Beleuchtung brennt über Nacht. Zeitschaltuhren wären sinnvoll.",
      action: "Zeitschaltuhren einsetzen, Leerlaufregelung kommunizieren.",
      role: "Bauleitung",
      trade: "Allgemein",
    },
  ],
  "organisation.signalisation": [
    {
      sub: "organisation.signalisation",
      assessment: "negative",
      risk: "medium",
      title: "Signalisation der Baustellenzufahrt fehlt",
      description: "Signalisation und Absperrung der Baustellenzufahrt fehlen teilweise; Fussgänger queren den Arbeitsbereich.",
      action: "Signalisation gemäss Signalisationsplan ergänzen, Fussgängerführung abtrennen.",
      role: "Vorarbeiter Tiefbau",
      trade: "Strassenbau",
    ...
    },
    {
      ...
      assessment: "negative",
      risk: "high",
      title: "Absperrung Gefahrenbereich mangelhaft",
      description: "Absperrung beim Grabenbereich umgefallen, Gefahrenbereich nicht signalisiert.",
      action: "Absperrung wiederherstellen und täglich kontrollieren.",
      role: "Vorarbeiter Tiefbau",
      trade: "Strassenbau",
    },
    {
      ...
      assessment: "negative",
      risk: "medium",
      title: "Mangelhafte Beschilderung Umleitung",
      description: "Umleitungsbeschilderung für Fussgänger fehlt nach Phasenwechsel.",
      action: "Beschilderung an neue Bauphase anpassen.",
      role: "Bauleitung",
      trade: "Strassenbau",
    },
  ],
  "organisation.zutritt": [
    {
      sub: "organisation.zutritt",
      assessment: "negative",
      risk: "medium",
      title: "Bauzaun offen",
      description: "Bauzaun bei der Anlieferung steht offen, unbefugter Zutritt möglich.",
      action: "Bauzaun schliessen, Zutrittsregelung durchsetzen.",
      role: "Polier",
      trade: "Allgemein",
    },
  ],
...
const INSPECTIONS: {
...
}[] = [
  {
    ...
    weather: "Sonnig, 18 °C",
    area: "Rohbau",
    findings: ["absturz.seitenschutz", "psa.helm", "ordnung.lager", "notfall.plan"],
  },
  {
    site: "birr",
    daysAgo: 130,
    inspector: "pl_hochbau",
    type: "routine",
    weather: "Bewölkt",
    area: "Rohbau",
    findings: ["ordnung.stolper", "geruest.freigabe", "leitern.zustand", "instruktion.av"],
  },
  {
    site: "birr",
    daysAgo: 84,
    ...
    weather: "Regen",
    area: "Rohbau / Gerüst",
    findings: ["absturz.seitenschutz", "geruest.belag", "psa.helm", "ordnung.stolper", "brand.loeschmittel"],
  },
  {
    site: "birr",
    daysAgo: 55,
    ...
    weather: "Sonnig",
    area: "Rohbau",
    findings: ["absturz.seitenschutz", "oeffnungen.abdeckung", "psa.warn", "instruktion.nachweis"],
  },
  {
    site: "birr",
    daysAgo: 26,
    ...
    weather: "Sonnig, 24 °C",
    area: "Rohbau / Fassade",
    findings: ["absturz.seitenschutz", "psa.helm", "ordnung.stolper", "elektro.kabel", "geruest.freigabe"],
  },
  {
    site: "birr",
    daysAgo: 6,
    ...
    weather: "Wechselhaft",
    area: "Rohbau",
    findings: ["absturz.seitenschutz", "ordnung.stolper", "psa.gehoer_augen", "notfall.plan"],
  },
  {
    site: "aargau",
    daysAgo: 150,
    ...
    weather: "Kalt, 4 °C",
    area: "Rückbau",
    findings: ["staub_laerm.staub", "elektro.provisorium", "gefahrstoffe.lagerung", "instruktion.av"],
  },
  {
    site: "aargau",
    daysAgo: 95,
    ...
    weather: "Bewölkt",
    area: "Innenausbau",
    findings: ["elektro.provisorium", "verkehr.fluchtweg", "notfall.material", "brand.loeschmittel", "umwelt.abfall"],
  },
  {
    site: "aargau",
    daysAgo: 48,
    ...
    weather: "Sonnig",
    area: "Haustechnik",
    findings: ["elektro.provisorium", "elektro.verteiler", "brand.heissarbeiten", "nachhaltigkeit.energie"],
  },
  {
    site: "aargau",
    daysAgo: 12,
    ...
    weather: "Sonnig",
    area: "Innenausbau",
    findings: ["elektro.provisorium", "qualitaet.schutz", "ordnung.stolper", "notfall.plan"],
  },
  {
    site: "strasse",
    daysAgo: 160,
    inspector: "pl_tiefbau",
    type: "routine",
    weather: "Sonnig",
    area: "Leitungsbau",
    findings: ["graben.verbau", "organisation.signalisation", "psa.warn"],
  },
  {
    site: "strasse",
    daysAgo: 110,
    ...
    weather: "Regen",
    area: "Leitungsbau",
    findings: ["organisation.signalisation", "graben.rand", "umwelt.gewaesser", "gefahrstoffe.lagerung"],
  },
  {
    site: "strasse",
    daysAgo: 62,
    ...
    weather: "Heiss, 31 °C",
    area: "Strassenbau",
    findings: ["organisation.signalisation", "psa.helm", "psa.warn", "umwelt.abfall"],
  },
  {
    site: "strasse",
    daysAgo: 20,
    ...
    weather: "Sonnig",
    area: "Leitungsbau",
    findings: ["organisation.signalisation", "graben.verbau", "krane.anschlagmittel", "notfall.plan"],
  },
  {
    site: "strasse",
    daysAgo: 3,
    ...
    weather: "Bewölkt",
    area: "Strassenbau",
    findings: ["organisation.signalisation", "organisation.zutritt", "psa.warn"],
  },
  {
    site: "zuerich",
    daysAgo: 140,
    ...
    type: "acceptance",
    weather: "Nebel",
    area: "Aushub / Baugrube",
    findings: ["graben.rand", "verkehr.fluchtweg", "ordnung.lager"],
  },
  {
    site: "zuerich",
    daysAgo: 70,
    ...
    weather: "Sonnig",
    area: "Rohbau",
    findings: ["absturz.dach", "psa.helm", "ordnung.stolper", "krane.anschlagmittel", "instruktion.av"],
  },
  {
    site: "zuerich",
    daysAgo: 33,
    ...
    weather: "Sonnig",
    area: "Rohbau",
    findings: ["absturz.seitenschutz", "elektro.provisorium", "qualitaet.ausfuehrung", "brand.loeschmittel"],
  },
  {
    site: "zuerich",
    daysAgo: 9,
    ...
    weather: "Regen",
    area: "Rohbau / Dach",
    findings: ["absturz.dach", "psa.helm", "ordnung.stolper", "geruest.belag", "notfall.material"],
  },
];
...
async function insertAuthUser(tx: Tx, id: string, email: string, fullName: string) {
  ...
  const hasIdentities =
    (await tx`select 1 from information_schema.tables where table_schema = 'auth' and table_name = 'identities'`).length > 0;
  if (hasIdentities) {
    await tx.unsafe(
...
async function main() {
  ...
  const ids = await withService(async (tx) => {
    ...
    const settings: [string, unknown, string][] = [
      ...
      [
        "retention",
        { inspectionsYears: 10, imagesYears: 5, emailLogYears: 10, auditLogYears: 10, aiSuggestionsDays: 365 },
    ...
    const items = frequent.map((k) => {
      ...
      return {
        ...
        subcategory_code: t.sub,
        assessment: t.assessment,
        risk_level: t.risk,
        action: t.action ?? null,
        responsible_role: t.role ?? null,
      };
    });
    ...
    await tx`insert into public.inspection_templates (company_id, name, description, inspection_type, items)
             values (${companyIds.get("tiefbau")!}, 'Tiefbau – Gräben und Signalisation', 'Schwerpunkte Leitungs- und Strassenbau', 'routine',
                     ${tx.json([
                       {
                         title: T["graben.verbau"][0].title,
                         category_code: "graben",
                         subcategory_code: "graben.verbau",
                         assessment: "negative",
                         risk_level: "critical",
                         action: T["graben.verbau"][0].action,
                         responsible_role: "Vorarbeiter Tiefbau",
                       },
                       {
                         title: T["organisation.signalisation"][0].title,
                         category_code: "organisation",
                         subcategory_code: "organisation.signalisation",
                         assessment: "negative",
                         risk_level: "medium",
                         action: T["organisation.signalisation"][0].action,
                         responsible_role: "Vorarbeiter Tiefbau",
                       },
                       {
                         title: T["psa.warn"][0].title,
                         category_code: "psa",
                         subcategory_code: "psa.warn",
                         assessment: "positive",
                         risk_level: null,
                         action: null,
    ...
    for (const plan of INSPECTIONS) {
      ...
      for (let i = 0; i < plan.findings.length; i++) {
        ...
        for (let k = 0; k < imageNumber; k++) {
          const jpg = await sharp(demoPhotoSvg(t.title, findingCount + k, t.assessment))
            .jpeg({ quality: 82 })
            .toBuffer();
